<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="D_Hellas.about" %>
<!doctype html>
                    ...
                    <div class="container">
                        ...
                        <div id="main-nav" class="stellarnav">
                            <ul id="nav" class="nav navbar-nav">
                                ...
                                <li><a href="service.html">Projects</a>
                                    <!-- <ul>
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-image">
                            <img src="img/service/lift2.jpg" alt="">
                        </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-image">
                            <img src="img/service/lift3.jpg" alt="">
                        </div>
                        <div class="blog-details text-center">
                ...
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="single-blog wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <img src="img/service/lift1.jpg" alt="">
                        </div>
                        <div class="blog-details text-center">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="footer-copyright wow fadeIn">
                            ...
                            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | D'Hellas </p>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
